...
namespace MindHub.DAL.Migrations
{
    ...
    [Migration("20260421123104_AddNodeSizeAndCodeBlockState")]
    partial class AddNodeSizeAndCodeBlockState
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MindHub.DAL.Node", b =>
                {
                    ...
                    b.Property<bool>("IsCodeBlockOpen")
            ...
            modelBuilder.Entity("MindHub.Domain.Invite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MindHub.Domain.NodeVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MindHub.Domain.Invite", b =>
                {
                    b.HasOne("MindHub.DAL.User", "Inviter")
                        .WithMany()
